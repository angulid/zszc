...
class CreatePro:
    ...
    def pro_create(self, gov_pro):
        ...
        self.pm.enter_gov_pro_page(driver)
        self.ppe.add_gov_pro_submit(driver, gov_pro)
    ...
    def pro_add_buy_file_zonghe(self,gov_pro):
        """采购文件-综合评分法"""
        driver = self.login_zbr()
        self.pm.enter_gov_pro_process(driver, gov_pro)
        self.pop.add_purchase_file(driver)
        self.psbi.set_base_info(driver, gov_pro)
    ...
    def pro_add_buy_file_lowest(self,gov_pro):
        """采购文件-最低评分法"""
        driver = self.login_zbr()
        self.pm.enter_gov_pro_process(driver, gov_pro)
        self.pop.add_purchase_file(driver)
